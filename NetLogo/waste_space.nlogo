...
to setup-patches
  ...
  [
    ...
    if (region = 2)  [
      set start-resources random (max-resources * 0.8)
      set resources start-resources
      set pcolor brown
    ]
    if (region = 3)  [
      set start-resources random (max-resources * 0.7)
      set resources start-resources
      set pcolor green
    ]
    if (region = 4)  [
      set start-resources random (max-resources * 0.6)
      set resources start-resources
      set pcolor blue
    ]
  ]
...
to setup-turtles
  ...
  [
    ...
    ;set color scale-color grey waste-prob 0 1
    set-turtle-color
    set birthplacex xcor
    set birthplacey ycor
  ]
end
...
;;Agents
to set-turtle-color
  if (agent-color = "waste")[
    set color scale-color grey waste-prob 0 1
  ]
  if (agent-color = "region")[
    if (region = 1)[
      set color red
    ]
    if (region = 2)[
  ...
  ask turtles [
    if random-float 1 <= move-prob [
      if energy >= move-cost [
        ...
        rt random 360
        let current_region [region] of patch-here
        if ([region] of patch-ahead 1 != current_region) and (random-float 1 <= Viscosity) [
          let p neighbors with [region = current_region]
          face one-of p
        ]
        forward 1
      ]
...
to gather-turtles
  ask turtles [
    if resources > 0 [
      ...
      set pcolor scale-color pcolor resources 0 max-resources
    ]
  ]
end
...
to export-reports
  ...
  r:eval "save.image(file=paste('/Volumes/WCCDefiant/Academia/Projects/WasteSpace/Results/Simulation/',f,'.RData',sep=''))"
  r:clear
  r:gc
end
...
<experiments>
  ...
  <experiment name="exp10" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="Viscosity">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Decay">
      <value value="true"/>
    ...
    <enumeratedValueSet variable="Homing">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="export_res">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="waste-drift">
      <value value="0.1"/>
  ...
  <experiment name="exp11" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp12" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp13" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp14" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp15" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp16" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp17" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp18" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp19" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp20" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp21" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp22" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp23" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp24" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp25" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp26" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp27" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="move-cost">
  ...
  <experiment name="Exp30" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp31" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp32" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp33" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp34" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp35" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp36" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp37" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp38" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp39" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp40" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp41" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp42" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp43" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp44" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp45" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp46" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="climateSD">
  ...
  <experiment name="Exp47" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp48" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp49" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp50" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp51" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp52" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp53" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp54" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp55" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp56" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="decay-rate">
  ...
  <experiment name="Exp57" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="regrowth">
  ...
  <experiment name="Exp58" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="regrowth">
  ...
  <experiment name="Exp59" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="regrowth">
  ...
  <experiment name="Exp60" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="regrowth">
  ...
  <experiment name="Exp61" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="regrowth">
  ...
  <experiment name="Exp62" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="regrowth">
  ...
  <experiment name="Exp63" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="regrowth">
